...
/**
 * The Class TTVConnectionManagement.
 */
public class TTVConnectionManagement extends SuperTest {
	/** The test. */
	...
	public void TC03_RelationShipDrillDown() {
		...
		// test.ttvConMngPage.addNewDocumentChange();
	}

	@Test
	public void TC04_RelationShipDrillDown() {
		test.contactPage.navigateToDocumentAfterRelationShipTab();
	}
	...
	public void TC05_addNewDocumentAndSelectType() {
		...
		test.ttvConMngPage.addNewDocumentAndSelectType("TTV", "Change Distributor");
	}
	...
	@Test
	public void TC07_addTargetDistributorName() {
		test.ttvConMngPage.addTargetDistributorName();
	}

...
public class TCRV_Order_Replacement extends SuperTest {
	/** The test. */
	...
	public void TC07_addNewDocumentAndSelectType() {
		test.ttvConMngPage.addNewDocumentAndSelectType("TCRV", "Replacement");
	}

	@Test
	public void TC08_addTCRVLostEquipment() {
	...
	public void TC10_AddComment() {
		...
		test.ttvConMngPage.AddReplacementInformation();
	}

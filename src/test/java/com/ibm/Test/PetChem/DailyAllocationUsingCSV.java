 ...
 */
public class DailyAllocationUsingCSV extends SuperTest {
    /**
     * The test.
     */
    ...
    public void TC02_navigateToDailyAllocation() throws TesseractException, IOException {
    	...
    	test.petChemPage.dailyAllocationQuery();
    }
    ...
    public void TC03_dailyAllocation() {
    	...
    	test.petChemPage.importDailyAllocation();
    	test.petChemPage.alertVerificationAndAcceptAlert(20);

 ...
 */
public class PartnerEmployeeManager extends SuperTest {
    /**
     * The test.
     */
    ...
    public void TC06_AddPositionEmployee() {
        ...
        test.partnerEmpPage.employeePosition("LPG Manager");
    }
    ...
    public void TC07_AddDesignationEmployee() {
        ...
        test.partnerEmpPage.employeeDesignation("Manager");
    }

    /**
     * TC add details for new employee-Manager.
     */
    @Test
